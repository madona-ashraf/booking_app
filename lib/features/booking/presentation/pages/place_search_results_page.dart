  ...
  List<TouristAttraction> _getFallbackAttractions() {
    return [
      TouristAttraction(
        ...
        description: 'The heart of ${widget.placeName}, featuring historic architecture and cultural landmarks.',
      ...
      TouristAttraction(
        ...
        latitude: widget.latitude - 0.01,
        longitude: widget.longitude - 0.01,
        description: 'A beautiful park in ${widget.placeName} perfect for relaxation and outdoor activities.',
      ...
      TouristAttraction(
        ...
        description: 'Explore the rich history and culture of ${widget.placeName} at this renowned museum.',
      ...
      TouristAttraction(
        ...
        latitude: widget.latitude - 0.005,
        longitude: widget.longitude + 0.005,
        description: 'A stunning architectural masterpiece and important religious site in ${widget.placeName}.',
      ...
      TouristAttraction(
        ...
        description: 'Discover local shops, markets, and boutiques in ${widget.placeName}\'s vibrant shopping area.',
